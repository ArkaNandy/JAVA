...
public class ArrayLists { 
    ...
    /// Arraylist stores objects, ie if we want to store integer number we have to use integer class
    ArrayList<Integer> list1 = new ArrayList<>(); // Array list of integer type objects
    //ArrayList<Float> list2 =new ArrayList<>(); // we creating the object of the Arraylist
  ...
  int element = list1.get(0); //// inside get() we need to put the index of the arraylist we want amd store it inside an integer 
  ...
  list1.set(0,5); //(the postion of the element we want to change, the value we want to change it with)
  System.out.println(list1);
  ...
  /// sorting ,Inside java we can automatically sort elements by just using a function
