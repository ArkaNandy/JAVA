...
public class DynamicStack extends StackImplementation {
    ...
    public boolean push(int item){ // here we are overriding the push method of the parent class
        ...
        return super.push(item); // if the array is not full then we are using the normal push method which is present in the super class
    ...
    public static void main(String[] args) throws Exception {
        ...
        dstack1.push(45); // here 45 is being pushed in first, it will definitely be the last one to get popped
        dstack1.push(29);
        dstack1.push(44);
        dstack1.push(57);
        dstack1.push(64);
