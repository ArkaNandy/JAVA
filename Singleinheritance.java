...
public class Singleinheritance {
    public static void main(String args[]){
        ...
        t1.colour ="red"; // here we dont't have colour mentioned in class triangle but still we can link the object t1 
         ...
         t1.area(); // calling the non parameterised method in parent class shape
         t1.area(4,5); // calling the the parameterised method in child class triangle which is inherited from shape
